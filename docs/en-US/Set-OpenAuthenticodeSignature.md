...
It will replace an existing signatures on the file with the new one generated by the cmdlet.
To add a signature to an existing set, use [Add-OpenAuthenticodeSignature](./Add-OpenAuthenticodeSignature.md).
